...
/**
 * generateCampusClasses generates the campus.generated.ts file containing the
 * CampusIdentifier enum. This enum is used to identify the campus in the
 * interface.
 * @param campusIdentifiers list of campus identifiers (e.g. ['helsinki', 'paris', ...])
 */
const generateCampusClasses = (campusIdentifiers: any[]): void => {
  ...
  const campusesContent = `${GeneratedWarning}import { CampusIdentifier, ICampus } from './types';
${campusIdentifiers
...
`;
  ...
  c.log('✔ Generated campus.generated.ts file successfully!');
};
