...
const colorClasses = {
  ...
  yellow:
    'bg-yellow-500/20 border-yellow-500 text-yellow-700 dark:text-yellow-300 hover:bg-yellow-500/50',
  red: 'bg-red-500/20 border-red-500 text-red-700 dark:text-red-300 hover:bg-red-500/50',
  orange:
    'bg-orange-500/20 border-orange-500 text-orange-700 dark:text-orange-300 hover:bg-orange-500/50',
  gray: 'bg-slate-500/20 border-slate-500 text-slate-700 dark:text-slate-300 hover:bg-slate-500/50',
  white:
    'bg-gray-200/20 border-gray-200 text-gray-700 dark:text-gray-300 hover:bg-gray-200/50',
  black:
    'bg-gray-900/20 border-gray-900 text-gray-700 dark:text-gray-300 hover:bg-gray-900/50',
