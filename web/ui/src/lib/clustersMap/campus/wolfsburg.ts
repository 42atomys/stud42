    ...
    return [
      ...
      new Cluster({
        ...
        map: [
          ...
          ['T:s7',  'W:c2s7d1',  'W:c2s7d2',  'W:c2s7d3',  'W:c2s7d4',  'W:c2s7d5',  'W:c2s7d6',  'T:s7' ],
          ['T:s6',  'W:c2s6d1',  'W:c2s6d2',  'W:c2s6d3',  'W:c2s6d4',  'W:c2s6d5',  'W:c2s6d6',  'T:s6' ],
          ['T:s5',  'W:c2s5d1',  'W:c2s5d2',  'W:c2s5d3',  'W:c2s5d4',  'W:c2s5d5',  'W:c2s5d6',  'T:s5' ],
          ['T:s4',  'W:c2s4d1',  'W:c2s4d2',  'W:c2s4d3',  'W:c2s4d4',  'W:c2s4d5',  'W:c2s4d6',  'T:s4' ],
          ['T:s3',  'W:c2s3d1',  'W:c2s3d2',  'W:c2s3d3',  'W:c2s3d4',  'W:c2s3d5',  'W:c2s3d6',  'T:s3' ],
          ['T:s2',  'W:c2s2d1',  'W:c2s2d2',  'W:c2s2d3',  'W:c2s2d4',  'W:c2s2d5',  'W:c2s2d6',  'T:s2' ],
          ['T:s1',  'W:c2s1d1',  'W:c2s1d2',  'W:c2s1d3',  'W:c2s1d4',  'W:c2s1d5',  'W:c2s1d6',  'T:s1' ],
        ],
      })
   ];
  }
